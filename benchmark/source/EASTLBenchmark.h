...
namespace Benchmark
{
	...
	struct Environment
	{
		std::string8 msPlatform;       // Name of test platform (e.g. "Windows")
		std::string8 msSTLName1;       // Name of competitor #1 (e.g. "EASTL").
		std::string8 msSTLName2;       // Name of competitor #2 (e.g. "MS STL").
	...
	struct Result
	{
		std::string8       msName;    // Test name (e.g. "vector/insert").
		...
		std::string8       msNotes;   // Any comments to attach to this result.
