...
void BenchmarkHeap()
{
...

	{
		...
		std::generate(pIntArrayS, pIntArrayS + kArraySize, rng);
		std::copy(pIntArrayS, pIntArrayS + kArraySize, pIntArrayE);
		std::copy(pIntArrayS, pIntArrayS + kArraySize, pIntArray2);


		// vector<TestObject>
		std::vector<TestObject>   stdVectorTO(kArraySize * 2);
		std::vector<TestObject>   stdVectorTO2(kArraySize);
		std::vector<TestObject> eaVectorTO(kArraySize * 2);
		std::vector<TestObject> eaVectorTO2(kArraySize);
