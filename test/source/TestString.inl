...
int TEST_STRING_NAME()
{
	...
	struct SSOFailocatorString : public std::basic_string<typename StringType::value_type, Failocator>
	{
		using std::basic_string<typename StringType::value_type, Failocator>::basic_string;
		using std::basic_string<typename StringType::value_type, Failocator>::IsSSO;
	};
	...
	// basic_string(CtorConvert, const OtherStringType& x);
	{
		{
		#if defined(EA_CHAR8)
			StringType str(typename StringType::CtorConvert(), std::basic_string<char8_t, typename StringType::allocator_type>(EA_CHAR8("123456789")));
			VERIFY(str == LITERAL("123456789"));
			VERIFY(str.validate());
		#endif
		}
		{
		#if defined(EA_CHAR16)
			StringType str(typename StringType::CtorConvert(), std::basic_string<char16_t, typename StringType::allocator_type>(EA_CHAR16("123456789")));
			VERIFY(str == LITERAL("123456789"));
			VERIFY(str.validate());
		#endif
		}
		{
		#if defined(EA_CHAR32)
			StringType str(typename StringType::CtorConvert(), std::basic_string<char32_t, typename StringType::allocator_type>(EA_CHAR32("123456789")));
			VERIFY(str == LITERAL("123456789"));
			VERIFY(str.validate());
		#endif
		}
		{
		#if defined(EA_WCHAR)
		    StringType str(typename StringType::CtorConvert(), std::basic_string<wchar_t, typename StringType::allocator_type>(EA_WCHAR("123456789")));
		    VERIFY(str == LITERAL("123456789"));
		    VERIFY(str.validate());
		#endif
		}
	...
	//     this_type& operator=(const OtherStringType& x);
	{
		...
		}
		{
			...
			#if defined(EA_CHAR8)
				StringType str(LITERAL("abcdefghijklmnopqrstuvwxyz"));
				str = std::basic_string<char8_t>(EA_CHAR8("123456789"));
				VERIFY(str == LITERAL("123456789"));
				VERIFY(str.validate());
			#endif
			}
			...
			#if defined(EA_CHAR16)
				StringType str(LITERAL("abcdefghijklmnopqrstuvwxyz"));
				str = std::basic_string<char16_t>(EA_CHAR16("123456789"));
				VERIFY(str == LITERAL("123456789"));
				VERIFY(str.validate());
			#endif
			}
			...
			#if defined(EA_CHAR32)
				StringType str(LITERAL("abcdefghijklmnopqrstuvwxyz"));
				str = std::basic_string<char32_t>(EA_CHAR32("123456789"));
				VERIFY(str == LITERAL("123456789"));
				VERIFY(str.validate());
			#endif
			}
			...
			#if defined(EA_WCHAR)
				StringType str(LITERAL("abcdefghijklmnopqrstuvwxyz"));
				str = std::basic_string<wchar_t>(EA_WCHAR("123456789"));
				VERIFY(str == LITERAL("123456789"));
				VERIFY(str.validate());
			#endif
			}
	...
	// this_type& assign_convert(const OtherStringType& x);
	{
		...
		#if defined(EA_CHAR8)
			StringType str(LITERAL("abcdefghijklmnopqrstuvwxyz"));
			std::basic_string<char8_t> str2(EA_CHAR8("123456789"));
		...
		#if defined(EA_CHAR16)
			StringType str(LITERAL("abcdefghijklmnopqrstuvwxyz"));
			std::basic_string<char16_t> str2(EA_CHAR16("123456789"));
		...
		#if defined(EA_CHAR32)
			StringType str(LITERAL("abcdefghijklmnopqrstuvwxyz"));
			std::basic_string<char32_t> str2(EA_CHAR32("123456789"));
		...
		#if defined(EA_WCHAR)
		    StringType str(LITERAL("abcdefghijklmnopqrstuvwxyz"));
		    std::basic_string<wchar_t> str2(EA_WCHAR("123456789"));
	...
	// this_type& append_convert(const OtherStringType& x);
	{
		...
		#if defined(EA_CHAR8)
			StringType str; 
			str.append_convert(std::u8string(EA_CHAR8("123456789")));
			VERIFY(str == LITERAL("123456789"));
			VERIFY(str.validate());
		#endif
		}
		...
		#if defined(EA_CHAR16)
			StringType str; 
			str.append_convert(std::string16(EA_CHAR16("123456789")));
			VERIFY(str == LITERAL("123456789"));
			VERIFY(str.validate());
		#endif
		}
		...
		#if defined(EA_CHAR32)
			StringType str;
			str.append_convert(std::string32(EA_CHAR32("123456789")));
			VERIFY(str == LITERAL("123456789"));
			VERIFY(str.validate());
		#endif
		}
		...
		#if defined(EA_WCHAR)
		    StringType str;
		    str.append_convert(std::wstring(EA_WCHAR("123456789")));
		    VERIFY(str == LITERAL("123456789"));
		    VERIFY(str.validate());
		#endif
		}
	...
	// void push_back(value_type c);
	{
		...
		std::for_each(std::begin(src), std::end(src), [&str](const typename StringType::value_type& c)
		                { str.push_back(c); });
	...
	{
		StringType str(LITERAL("abcdefghijklmnopqrstuvwxyz"));
		[&](basic_string_view<typename StringType::value_type> sv)  // simulate api that requires std::string_view.
		{
			VERIFY(sv.compare(LITERAL("abcdefghijklmnopqrstuvwxyz")) == 0);
		}(str);
	}

	// test constructing a std::basic_string from an std::basic_string_view
	{
	...
	// test assigning from an std::basic_string_view
	{
		using StringViewType = basic_string_view<typename StringType::value_type>;
		StringViewType sv = LITERAL("abcdefghijklmnopqrstuvwxyz");
	...
	{
		StringType str(LITERAL("abcdefghijklmnopqrstuvwxyz"));
		std::erase(str, LITERAL('a'));
		std::erase(str, LITERAL('f'));
		std::erase(str, LITERAL('l'));
		std::erase(str, LITERAL('w'));
		std::erase(str, LITERAL('y'));
	...
	{
		StringType str(LITERAL("abcdefghijklmnopqrstuvwxyz"));
		std::erase_if(str, [](auto c) { return c == LITERAL('a') || c == LITERAL('v'); });
	...
	// template<> struct hash<std::u32string>;
	{
		...
		// hashing functor that defers to the std::basic_string<CharT> hash implementation; effectively ignoring the
		// custom allocator.
	    auto LocalHash = [](auto s) -> size_t {
		    using UserStringType = decltype(s);
		    using TargetType = std::basic_string<typename UserStringType::value_type>;

		    TargetType t(s.data());
		    return std::hash<TargetType>{}(t);
	    };
