...
template class std::vector_set<int>;
template class std::vector_multiset<float>;
template class std::vector_set<TestObject>;
template class std::vector_multiset<TestObject>;


///////////////////////////////////////////////////////////////////////////////
// typedefs
//
typedef std::vector_set<int> VS1;
typedef std::vector_set<int, std::less<int>, EASTLAllocatorType, std::deque<int> > VS2;
typedef std::vector_set<TestObject> VS4;
typedef std::vector_set<TestObject, std::less<TestObject>, EASTLAllocatorType, std::deque<TestObject> > VS5;
typedef std::vector_multiset<int> VMS1;
typedef std::vector_multiset<int, std::less<int>, EASTLAllocatorType, std::deque<int> > VMS2;
typedef std::vector_multiset<TestObject> VMS4;
typedef std::vector_multiset<TestObject, std::less<TestObject>, EASTLAllocatorType, std::deque<TestObject> > VMS5;
...
int TestVectorSet()
{
	...
	{ // find_as predicate
		{ // vector_set
			std::vector_set<string> vss = {"abc", "def", "ghi", "jklmnop", "qrstu", "vw", "x", "yz"};
			VERIFY(vss.find_as("GHI", TestStrCmpI_2()) != vss.end());
		}

		{ // const vector_set
			const std::vector_set<string> vss = {"abc", "def", "ghi", "jklmnop", "qrstu", "vw", "x", "yz"};
			VERIFY(vss.find_as("GHI", TestStrCmpI_2()) != vss.end());
		}

		{ // vector_multiset
			std::vector_multiset<string> vss = {"abc", "def", "ghi", "jklmnop", "qrstu", "vw", "x", "yz"};
			VERIFY(vss.find_as("GHI", TestStrCmpI_2()) != vss.end());
		}

		{ // const vector_multiset
			const std::vector_multiset<string> vss = {"abc", "def", "ghi", "jklmnop", "qrstu", "vw", "x", "yz"};
			VERIFY(vss.find_as("GHI", TestStrCmpI_2()) != vss.end());
		}
	}
