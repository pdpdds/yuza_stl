...
template class std::fixed_string<char8_t,    1,  true>;
template class std::fixed_string<char16_t,   1,  true>;
template class std::fixed_string<char32_t,   1,  true>;

template class std::fixed_string<char8_t,  128, false>;
template class std::fixed_string<char16_t, 128, false>;
template class std::fixed_string<char32_t, 128, false>;

template class std::fixed_string<char8_t,  128,  true, MallocAllocator>;
template class std::fixed_string<char16_t, 128,  true, MallocAllocator>;
template class std::fixed_string<char32_t, 128,  true, MallocAllocator>;

template class std::fixed_string<char8_t,  128, false, MallocAllocator>;
template class std::fixed_string<char16_t, 128, false, MallocAllocator>;
template class std::fixed_string<char32_t, 128, false, MallocAllocator>;

template class std::fixed_substring<char8_t>;
template class std::fixed_substring<char16_t>;
...
{
	std::fixed_string<StructWithContainerOfStructs,4> children;
};
*/
...
int TestFixedString()
{
...

	{
		...
		typedef std::fixed_string<char, 32, true, MallocAllocator> TestString;
