...
template class std::bitvector<>;
template class std::bitvector<MallocAllocator>;
template class std::bitvector<EASTLAllocatorType, uint8_t>;
template class std::bitvector<EASTLAllocatorType, int16_t>;
template class std::bitvector<EASTLAllocatorType, int32_t>;
template class std::bitvector<EASTLAllocatorType, int64_t, std::vector<int64_t, EASTLAllocatorType> >;

// bitvector doesn't yet support deque.
//template class std::bitvector<EASTLAllocatorType, uint8_t, std::deque<uint64_t, EASTLAllocatorType> >;
//template class std::bitvector<EASTLAllocatorType, uint8_t, std::deque<int32_t, EASTLAllocatorType, 64> >;
