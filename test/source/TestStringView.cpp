...
int TestStringView()
{
	...
	nErrorCount += TestBasicStringView<std::basic_string_view<char>>();
	nErrorCount += TestBasicStringView<std::string_view>();

	nErrorCount += TestBasicStringViewW<std::basic_string_view<wchar_t>>();
	nErrorCount += TestBasicStringViewW<std::wstring_view>();

#if EA_CHAR8_UNIQUE
	nErrorCount += TestBasicStringView8<std::basic_string_view<char8_t>>();
	nErrorCount += TestBasicStringView8<std::u8string_view>();
#endif

	nErrorCount += TestBasicStringView16<std::basic_string_view<char16_t>>();
	nErrorCount += TestBasicStringView16<std::u16string_view>();

#if EA_CHAR32_NATIVE
	nErrorCount += TestBasicStringView32<std::basic_string_view<char32_t>>();
	nErrorCount += TestBasicStringView32<std::u32string_view>();
#endif
	...
	#if EASTL_USER_LITERALS_ENABLED 
	{
		...
		static_assert(std::is_same_v<decltype("abcdef"_sv), std::string_view>, "string_view literal type mismatch");
		static_assert(std::is_same_v<decltype(u8"abcdef"_sv), std::u8string_view>, "string_view literal type mismatch");
		static_assert(std::is_same_v<decltype(u"abcdef"_sv), std::u16string_view>, "string_view literal type mismatch");
		static_assert(std::is_same_v<decltype(U"abcdef"_sv), std::u32string_view>, "string_view literal type mismatch");
		static_assert(std::is_same_v<decltype(L"abcdef"_sv), std::wstring_view>, "string_view literal type mismatch");
