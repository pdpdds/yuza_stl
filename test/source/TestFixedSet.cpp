...
template class std::fixed_set     <int,        1>;
template class std::fixed_multiset<float,      1>;
template class std::fixed_set     <Align64,    1>;
template class std::fixed_multiset<TestObject, 1>;


template class std::fixed_set     <int,        1, true, std::less<int>,        MallocAllocator>;
template class std::fixed_multiset<float,      1, true, std::less<float>,      MallocAllocator>;
template class std::fixed_set     <Align64,    1, true, std::less<Align64>,    MallocAllocator>;
template class std::fixed_multiset<TestObject, 1, true, std::less<TestObject>, MallocAllocator>;
...
typedef std::fixed_set<int, kContainerSize> VS1;
typedef std::fixed_set<TestObject, kContainerSize> VS4;
typedef std::fixed_multiset<int, kContainerSize> VMS1;
typedef std::fixed_multiset<TestObject, kContainerSize> VMS4;
...
int TestFixedSet()
{
...

	{
		...
		nErrorCount += TestSetCpp11<std::fixed_set<TestObject, 32> >();

		nErrorCount += TestMultisetCpp11<std::fixed_multiset<TestObject, 32> >();
	}
...

	{
		...
		typedef std::fixed_set<int, 100, false> FixedSetFalse;
...

	{
		...
		typedef std::fixed_set<int, 100, true> FixedSetTrue;
