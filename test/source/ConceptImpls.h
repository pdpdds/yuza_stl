...
// static_assert(!std::is_default_constructible<Destructible>::value,
// "!std::is_default_constructible<Destructible>::value");
// static_assert(!is_copy_constructible<Destructible>::value, "!std::is_copy_constructible<Destructible>::value");
static_assert(!std::is_copy_assignable<Destructible>::value, "!std::is_copy_assignable<Destructible>::value");
// static_assert(!std::is_move_constructible<Destructible>::value,
// "!std::is_move_constructible<Destructible>::value");
...
// static_assert(!std::is_default_constructible<CopyConstructible>::value,
// "!std::is_default_constructible<CopyConstructible>::value");
...
// static_assert(!std::is_move_constructible<CopyConstructible>::value,
// "!std::is_move_constructible<CopyConstructible>::value");
