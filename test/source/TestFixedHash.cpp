...
template class std::fixed_hash_set<int, 1, 2>;
template class std::fixed_hash_map<int, int, 1, 2>;
template class std::fixed_hash_multiset<int, 1, 2>;
template class std::fixed_hash_multimap<int, int, 1, 2>;

template class std::fixed_hash_set<A, 1, 2>;
template class std::fixed_hash_map<A, A, 1, 2>;
template class std::fixed_hash_multiset<A, 1, 2>;
template class std::fixed_hash_multimap<A, A, 1, 2>;

template class std::fixed_hash_set<int, 1, 2, true, std::hash<int>, std::equal_to<int>, true>;
template class std::fixed_hash_map<int, int, 1, 2, true, std::hash<int>, std::equal_to<int>, true>;
template class std::fixed_hash_multiset<int, 1, 2, true, std::hash<int>, std::equal_to<int>, true>;
template class std::fixed_hash_multimap<int, int, 1, 2, true, std::hash<int>, std::equal_to<int>, true>;

template class std::fixed_hash_set<A, 1, 2, true, std::hash<A>, std::equal_to<A>, true>;
template class std::fixed_hash_map<A, A, 1, 2, true, std::hash<A>, std::equal_to<A>, true>;
template class std::fixed_hash_multiset<A, 1, 2, true, std::hash<A>, std::equal_to<A>, true>;
template class std::fixed_hash_multimap<A, A, 1, 2, true, std::hash<A>, std::equal_to<A>, true>;

// Custom allocator
template class std::fixed_hash_set<int, 1, 2, true, std::hash<int>, std::equal_to<int>, false, MallocAllocator>;
template class std::fixed_hash_map<int, int, 1, 2, true, std::hash<int>, std::equal_to<int>, false, MallocAllocator>;
template class std::fixed_hash_multiset<int, 1, 2, true, std::hash<int>, std::equal_to<int>, false, MallocAllocator>;
template class std::fixed_hash_multimap<int, int, 1, 2, true, std::hash<int>, std::equal_to<int>, false, MallocAllocator>;

template class std::fixed_hash_set<A, 1, 2, true, std::hash<A>, std::equal_to<A>, false, MallocAllocator>;
template class std::fixed_hash_map<A, A, 1, 2, true, std::hash<A>, std::equal_to<A>, false, MallocAllocator>;
template class std::fixed_hash_multiset<A, 1, 2, true, std::hash<A>, std::equal_to<A>, false, MallocAllocator>;
template class std::fixed_hash_multimap<A, A, 1, 2, true, std::hash<A>, std::equal_to<A>, false, MallocAllocator>;
...
int TestFixedHash()
{
	...
	{ // fixed_hash_map
		{
			...
			typedef std::fixed_hash_map<int, int, 100, 100, false> FixedHashMapFalse;
...

		{
			...
			typedef std::fixed_hash_map<int, int, 100, 100, true> FixedHashMapTrue;
		...
		// been cleared.
		{
			...
			TestFixedHashMapClearBuckets<std::fixed_hash_map<int, int, ELEMENT_MAX, ELEMENT_MAX, false>,      ELEMENT_MAX,          ITERATION_MAX>();
			TestFixedHashMapClearBuckets<std::fixed_hash_map<int, int, ELEMENT_MAX, ELEMENT_MAX, true>,       ELEMENT_OVERFLOW_MAX, ITERATION_MAX>();
			TestFixedHashMapClearBuckets<std::fixed_hash_multimap<int, int, ELEMENT_MAX, ELEMENT_MAX, false>, ELEMENT_MAX,          ITERATION_MAX>();
			TestFixedHashMapClearBuckets<std::fixed_hash_multimap<int, int, ELEMENT_MAX, ELEMENT_MAX, true>,  ELEMENT_OVERFLOW_MAX, ITERATION_MAX>();
		}
		
		{
			// Test fixed_hash_map *with* overflow and ensure the underlying hashtable rehashes.
			typedef std::fixed_hash_map<unsigned int, unsigned int, 512, 513, true,  std::hash<unsigned int>, std::equal_to<unsigned int>, false, MallocAllocator> FixedHashMap;
		...
		{
			typedef std::fixed_hash_map<int, A, 100, 100> FixedHashMap;
			FixedHashMap fixedHashMap;
		...
		{
			typedef std::fixed_hash_map<A, int, 100, 100> FixedHashMap;
			FixedHashMap fixedHashMap;
		...
		{			
			typedef std::fixed_hash_map<int, int, 100, 100, true> FixedHashMapTrue;
			FixedHashMapTrue::value_type testValues[] = { std::make_pair(0, 0), std::make_pair(1,1) };
	...
	{ // fixed_hash_multimap
		{
			typedef std::fixed_hash_multimap<int, int, 100, 100> FixedHashMultiMap;
		...
		// explicitly instantiate some templated member functions
		{			
			typedef std::fixed_hash_multimap<int, int, 100, 100, true> FixedHashMultiMap;
			FixedHashMultiMap::value_type testValues[] = { std::make_pair(0, 0), std::make_pair(1,1) };
	...
	{ // fixed_hash_set
		{
			typedef std::fixed_hash_set<int, 100, 100> FixedHashSet;
		...
		{
			typedef std::fixed_hash_set<A, 100, 100> FixedHashSet;
			FixedHashSet fixedHashSet;
	...
	{ // fixed_hash_multiset
		{
			typedef std::fixed_hash_multiset<int, 100, 100> FixedHashMultiSet;
		...
		// explicitly instantiate some templated member functions
		{			
			typedef std::fixed_hash_multiset<A, 100, 100> FixedHashMultiSet;
	...
	{ // Tests of various bucketCount values.
		{
			typedef std::fixed_hash_set<int, 1, 2> FixedHashSet;
			FixedHashSet fixedHashSet;
		...
		{
			typedef std::fixed_hash_set<int, 2, 2> FixedHashSet;
			FixedHashSet fixedHashSet;
		...
		{
			typedef std::fixed_hash_set<int, 11, 11> FixedHashSet; // 11 is one of the hashtable prime numbers.
			FixedHashSet fixedHashSet;
	...
	{ // Test of user-reported crash.
		...
		typedef std::fixed_hash_map< 
			...
			std::equal_to<const void*>,            // Predicate
	...
	{  // Test of bug reported by Dave Wall, May 14, 2008.
		...
		typedef std::fixed_hash_map<const InstanceRenderData, uint32_t, kNumBuckets, kNumBuckets + 1, false> Map;
...

	{
		...
		typedef std::fixed_hash_map<int, int, 64, 100, true, std::hash<int>, std::equal_to<int>, false, MallocAllocator> Container;
...

	{
		...
		nErrorCount += TestMapCpp11<std::fixed_hash_map<int, TestObject,  2, 7, true> >();  // Exercize a low-capacity fixed-size container.
		nErrorCount += TestMapCpp11<std::fixed_hash_map<int, TestObject, 32, 7, true> >();

		nErrorCount += TestMapCpp11NonCopyable<std::fixed_hash_map<int, NonCopyable, 2, 7, true>>();

		nErrorCount += TestSetCpp11<std::fixed_hash_set<TestObject,  2, 7, true> >();
		nErrorCount += TestSetCpp11<std::fixed_hash_set<TestObject, 32, 7, true> >();

		nErrorCount += TestMultimapCpp11<std::fixed_hash_multimap<int, TestObject,  2, 7, true> >();
		nErrorCount += TestMultimapCpp11<std::fixed_hash_multimap<int, TestObject, 32, 7, true> >();

		nErrorCount += TestMultisetCpp11<std::fixed_hash_multiset<TestObject,  2, 7, true> >();
		nErrorCount += TestMultisetCpp11<std::fixed_hash_multiset<TestObject, 32, 7, true> >();
	}

	{
		// C++17 try_emplace and related functionality
		nErrorCount += TestMapCpp17<std::fixed_hash_map<int, TestObject,  2, 7, true>>();
		nErrorCount += TestMapCpp17<std::fixed_hash_map<int, TestObject, 32, 7, true> >();
	}
...

	{
		...
		typedef std::fixed_hash_map<int, int, ELEM_MAX, ELEM_MAX, false> FixedHashMapFalse;
		FixedHashMapFalse fixedHashMap;
		VERIFY(fixedHashMap.size() == 0);
...

		{
			...
			auto result = fixedHashMap.insert(std::move(value));
			VERIFY(result.second == false);
		}
		{
			FixedHashMapFalse::value_type value(0, 0);
			auto result = fixedHashMap.insert(fixedHashMap.begin(), std::move(value));
			VERIFY(result->first == 0);
			VERIFY(result->second == 0);
		}
		...
		{
			auto result = fixedHashMap.insert(std::make_pair(0, 0));
			VERIFY(result.second == false);
		}
