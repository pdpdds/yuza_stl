...
///    std::string16 s16;
///
///    s16 = EA::StdC::Strlcpy<std::string16, std::string8>(s8);   // 8  -> 16
///    s8  = EA::StdC::Strlcpy<std::string8,  std::string16>(s16); // 16 ->  8
///    s16 = EA::StdC::Strlcpy<std::string16, std::string16>(s16); // 16 -> 16  (merely returns the source)
///    s8  = EA::StdC::Strlcpy<std::string8,  std::string8>(s8);   //  8 ->  8  (merely returns the source)
///
namespace Internal
{
...
///
/// Example usage:
///    std::string16 s16 = Strlcpy<std::string16, char>("hello world");
///
namespace Internal
{
	template <typename Dest, typename DestCharType, typename Source>
...
///
/// Example usage:
///    std::wstring sW(L"hello ");
///    std::string8 s8("world");
///
...
namespace StdC
{
	...
	{
		return atof((char*)pString); // atof is well-implemented by most standard libraries.
	}
	...
	{
		return (float)atof((char*)pString); // atof is well-implemented by most standard libraries.
	}
