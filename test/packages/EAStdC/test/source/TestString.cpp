...
static int TestStringCore()
{
	...
	}
	{
		...
		std::fixed_string<char16_t, 32> s16; s16 = EA_CHAR16("\xffff"); s16 += EA_CHAR16("\xffff"); // We use a string object because some compilers don't support 16 bit string literals, and thus EA_CHAR16 is a function and doesn't just prepend "L" or "u" to the string.
	...
	}
	{
		...
		// We have to break up the string into multiple sub-strings because the \x escape sequence has limitations in how it works.
		std::fixed_string<char32_t, 32> s32; s32 = EA_CHAR32("\xffff"); s32 += EA_CHAR32("\xffff"); // We use a string object because some compilers don't support 32 bit string literals, and thus EA_CHAR32 is a function and doesn't just prepend "L" or "u" to the string.
...

	{
		...
		for(int i = 0; i < 20; i++)
		{
			...
			s2.assign(s1, 0, std::min_alt(s1.size(), s2.size()));
...
static int TestConvertString()
{
	...
	std::string8  s8 = EA_CHAR8("hello world");
	std::string16 s16;
	std::string32 s32;
	...
	{
		// 8 -> 8
		EA::StdC::Strlcpy<std::string8, std::string8>(s8, std::string8(EA_CHAR8("hello world")));
		EATEST_VERIFY(s8 == EA_CHAR8("hello world"));
		s8.clear();

		// 16 -> 16
		EA::StdC::Strlcpy<std::string16, std::string16>(s16, std::string16(EA_CHAR16("hello world")));
		EATEST_VERIFY(s16 == EA_CHAR16("hello world"));
		s16.clear();

		// 32 -> 32
		EA::StdC::Strlcpy<std::string32, std::string32>(s32, std::string32(EA_CHAR32("hello world")));
		EATEST_VERIFY(s32 == EA_CHAR32("hello world"));
		s32.clear();
	}
	...
	// inline Dest Strlcpy(const Source& s);
	{
		// 8 -> 16
		s8 = EA_CHAR8("hello world");
		s16 = EA::StdC::Strlcpy<std::string16,  std::string8>(s8);
		EATEST_VERIFY(s16 == EA_CHAR16("hello world"));
		s8.clear();

		// 16 -> 8
		s8 = EA::StdC::Strlcpy<std::string8, std::string16>(s16);
		EATEST_VERIFY(s8 == EA_CHAR8("hello world"));
		s16.clear();
	}
	{
		// 8 -> 32
		s32 = EA::StdC::Strlcpy<std::string32, std::string8>(s8);
		EATEST_VERIFY(s32 == EA_CHAR32("hello world"));
		s8.clear();

		// 32 -> 8
		s8 = EA::StdC::Strlcpy<std::string8, std::string32>(s32);
		EATEST_VERIFY(s8 == EA_CHAR8("hello world"));
		s32.clear();
	}
	{
		// 8 -> 8
		s8 = EA::StdC::Strlcpy<std::string8, std::string8>(std::string8(EA_CHAR8("hello world")));
		EATEST_VERIFY(s8 == EA_CHAR8("hello world"));
		s8.clear();

		// 16 -> 16
		s16 = EA::StdC::Strlcpy<std::string16, std::string16>(std::string16(EA_CHAR16("hello world")));
		EATEST_VERIFY(s16 == EA_CHAR16("hello world"));
		s16.clear();

		// 32 -> 32
		s32 = EA::StdC::Strlcpy<std::string32, std::string32>(std::string32(EA_CHAR32("hello world")));
		EATEST_VERIFY(s32 == EA_CHAR32("hello world"));
		s32.clear();
	}
	...
	{
		// 8 -> 16
		s16 = EA::StdC::Strlcpy<std::string16, char>("hello world", 11);
		EATEST_VERIFY(s16 == EA_CHAR16("hello world"));
		s8.clear();

		// 16 -> 8
		s8 = EA::StdC::Strlcpy<std::string8, char16_t>(EA_CHAR16("hello world"), 11);
		EATEST_VERIFY(s8 == EA_CHAR8("hello world"));
		s16.clear();
	}
	{
		// 8 -> 32
		s32 = EA::StdC::Strlcpy<std::string32, char>("hello world", 11);
		EATEST_VERIFY(s32 == EA_CHAR32("hello world"));
		s8.clear();

		// 32 -> 8
		s8 = EA::StdC::Strlcpy<std::string8, char32_t>(EA_CHAR32("hello world"), 11);
		EATEST_VERIFY(s8 == EA_CHAR8("hello world"));
		s32.clear();
	}
	{
		// 8 -> 8
		s8 = EA::StdC::Strlcpy<std::string8, char>("hello world", 11);
		EATEST_VERIFY(s8 == EA_CHAR8("hello world"));
		s8.clear();

		// 16 -> 16
		s16 = EA::StdC::Strlcpy<std::string16, char16_t>(EA_CHAR16("hello world"), 11);
		EATEST_VERIFY(s16 == EA_CHAR16("hello world"));
		s16.clear();

		// 32 -> 32
		s32 = EA::StdC::Strlcpy<std::string32, char32_t>(EA_CHAR32("hello world"), 11);
		EATEST_VERIFY(s32 == EA_CHAR32("hello world"));
		s32.clear();
	}
	...
	// inline bool Strlcat(Dest& d, const Source& s);
	{
		// 8 -> 16
		s16 = EA_CHAR16("abc ");
		EA::StdC::Strlcat(s16, std::string8(EA_CHAR8("hello world")));
		EATEST_VERIFY(s16 == EA_CHAR16("abc hello world"));

		// 16 -> 8
		s8 = EA_CHAR8("abc ");
		EA::StdC::Strlcat(s8, std::string16(EA_CHAR16("hello world")));
		EATEST_VERIFY(s8 == EA_CHAR8("abc hello world"));
	}
	{
		// 8 -> 32
		s32 = EA_CHAR32("abc ");
		EA::StdC::Strlcat(s32, std::string8(EA_CHAR8("hello world")));
		EATEST_VERIFY(s32 == EA_CHAR32("abc hello world"));

		// 32 -> 8
		s8 = EA_CHAR8("abc ");
		EA::StdC::Strlcat(s8, std::string32(EA_CHAR32("hello world")));
		EATEST_VERIFY(s8 == EA_CHAR8("abc hello world"));
	}
	{
		// 8 -> 8
		s8 = EA_CHAR8("abc ");
		EA::StdC::Strlcat(s8, std::string8(EA_CHAR8("hello world")));
		EATEST_VERIFY(s8 == EA_CHAR8("abc hello world"));
		s8.clear();

		// 16 -> 16
		s16 = EA_CHAR16("abc ");
		EA::StdC::Strlcat(s16, std::string16(EA_CHAR16("hello world")));
		EATEST_VERIFY(s16 == EA_CHAR16("abc hello world"));
		s16.clear();

		// 32 -> 32
		s32 = EA_CHAR32("abc ");
		EA::StdC::Strlcat(s32, std::string32(EA_CHAR32("hello world")));
		EATEST_VERIFY(s32 == EA_CHAR32("abc hello world"));
		s32.clear();
	}
	...
	{ // ConvertString is a deprecated name for Strlcpy.
		...
		{
			// 8 -> 16
			s16 = EA::StdC::ConvertString<std::string8,  std::string16>(s8);
			EATEST_VERIFY(s16 == EA_CHAR16("hello world"));
			s8.clear();

			// 16 -> 8
			s8 = EA::StdC::ConvertString<std::string16, std::string8>(s16);
			EATEST_VERIFY(s8 == EA_CHAR8("hello world"));
			s16.clear();
		}
		{
			// 8 -> 32
			s32 = EA::StdC::ConvertString<std::string8,  std::string32>(s8);
			EATEST_VERIFY(s32 == EA_CHAR32("hello world"));
			s8.clear();

			// 32 -> 8
			s8 = EA::StdC::ConvertString<std::string32, std::string8>(s32);
			EATEST_VERIFY(s8 == EA_CHAR8("hello world"));
			s32.clear();
		}
		...
		{
			// 8 -> 8
			s8 = EA::StdC::ConvertString<std::string8, std::string8>(std::string8(EA_CHAR8("hello world")));
			EATEST_VERIFY(s8 == EA_CHAR8("hello world"));
			s8.clear();

			// 16 -> 16
			s16 = EA::StdC::ConvertString<std::string16, std::string16>(std::string16(EA_CHAR16("hello world")));
			EATEST_VERIFY(s16 == EA_CHAR16("hello world"));
			s16.clear();

			// 32 -> 32
			s32 = EA::StdC::ConvertString<std::string32, std::string32>(std::string32(EA_CHAR32("hello world")));
			EATEST_VERIFY(s32 == EA_CHAR32("hello world"));
			s32.clear();
		}
		...
		{   //Regression for user-reported problem.
			...
			std::string16 path16 = EA::StdC::ConvertString<std::string8, std::string16>(pPath8);
