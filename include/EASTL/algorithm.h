...
//      move
//      move_backward
//      nth_element                                 Found in sort
//      nth_element<Compare>                        Found in sort
//      partial_sort                                Found in sort
//      partial_sort<Compare>                       Found in sort
...
//      set_union<Compare>
//      sort                                        Found in sort
//      sort<Compare>                               Found in sort
//      sort_heap                                   Found in heap.h
//      sort_heap<Compare>                          Found in heap.h
//      stable_sort                                 Found in sort
//      stable_sort<Compare>                        Found in sort
//      swap
//      swap_ranges
//      transform
//      transform<Operation>
...
EA_DISABLE_ALL_VC_WARNINGS();
	...
	#if defined(EA_COMPILER_MSVC) && (defined(EA_PROCESSOR_X86) || defined(EA_PROCESSOR_X86_64)) && !defined(SKYOS32)
		#include <intrin.h>
	#endif
