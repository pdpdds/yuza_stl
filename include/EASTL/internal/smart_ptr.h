...
namespace std
{
	...
	namespace Internal
	{
		...
		template <typename P1, typename P2, bool = std::is_same_v<std::remove_cv_t<typename pointer_traits<P1>::element_type>,
																    std::remove_cv_t<typename pointer_traits<P2>::element_type>>>
